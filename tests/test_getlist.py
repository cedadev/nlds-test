...
class TestGetList:
    ...
    def test_getlist_1(
        ...
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2], target=target, job_label="test_getlist_1"
        )
    ...
    def test_getlist_1a(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2], target=target, job_label="test_getlist_1a"
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE"
    ...
    def test_getlist_2(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2], target=target, job_label="test_getlist_2"
        )
        state = wait_completed(response=response)
    ...
    def test_getlist_3(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2], target=target, job_label="test_getlist_3"
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE_WITH_ERRORS"
    ...
    def test_getlist_4(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2], target=target, job_label="test_getlist_4"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_7(
        ...
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2],
            label="test_holding_2",
            target=target,
            job_label="test_getlist_7",
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE_WITH_ERRORS"
    ...
    def test_getlist_8(
        ...
        response = nlds_client.get_filelist(
            [filepath_1, filepath_2],
            label="test_holding_3",
            target=target,
            job_label="test_getlist_8",
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_24(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_regex], target=target, job_label="test_getlist_24"
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE"
        # count the files
    ...
    def test_getlist_25(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_regex], target=target, job_label="test_getlist_25"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_27(
        ...
        response = nlds_client.get_filelist(
            [filepath_regex],
            label="test_holding_10",
            target=target,
            job_label="test_getlist_27",
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_30(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_regex], holding_id=1, target=target, job_label="test_getlist_30"
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE"
        # count the files
    ...
    def test_getlist_31(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_regex], holding_id=10, target=target, job_label="test_getlist_31"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_32(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_regex], holding_id=1, target=target, job_label="test_getlist_32"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_33(
        ...
        target = get_target_dir().as_posix()
        response = nlds_client.get_filelist(
            [filepath_regex], holding_id=10, target=target, job_label="test_getlist_33"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_34(
        ...
        tag = {"filelist": "6 to 10"}
        response = nlds_client.get_filelist(
            [filepath_regex], tag=tag, target=target, job_label="test_getlist_34"
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE"
        # count the files
    ...
    def test_getlist_35(
        ...
        tag = {"filetype": "txt"}
        response = nlds_client.get_filelist(
            [filepath_regex], tag=tag, target=target, job_label="test_getlist_35"
        )
        state = wait_completed(response=response)
        assert state == "COMPLETE"
        # count the files
    ...
    def test_getlist_36(
        ...
        tag = {"filetype": "netCDF"}
        response = nlds_client.get_filelist(
            [filepath_regex], tag=tag, target=target, job_label="test_getlist_36"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_37(
        ...
        tag = {"filetype": "txt"}
        response = nlds_client.get_filelist(
            [filepath_regex], tag=tag, target=target, job_label="test_getlist_37"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
    ...
    def test_getlist_38(
        ...
        tag = {"filetype": "netCDF"}
        response = nlds_client.get_filelist(
            [filepath_regex], tag=tag, target=target, job_label="test_getlist_38"
        )
        state = wait_completed(response=response)
        assert state == "FAILED"
